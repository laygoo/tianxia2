...
public slots:
	...
	void kuailvBtnClicked();
	void wuyaoBtnClicked();

	void backMenpaiBtnClicked();
	void takeScreenShot();
	void weimaBtnClicked();
	void submitLiuliBtnClicked();
	void liuguangBtnClicked();
	void tuizuBtnClicked();
};
